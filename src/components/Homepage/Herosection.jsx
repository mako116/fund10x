...
const Herosection = () => {
  return (
    <main className="bg-linear2  heroScreen py-[0px] lg:py-[50px]">
     ...
     <p className=' text-ladies-white homeparagraph'>Fund10x, a funding platform that enables you to grow your business, with the right  capital, in the right manner</p>
     ...
     <div className="  ">
     <Link href="/investors">
     <button className='shadowed homebuttons mt-[15px] text-[15px] lg:text-[17.95px] p-paddi leading-[21.72px] font-medium text-[#fff]'>
     ...
     <div className=" ">
      <Link href="/bussiness">
     <button className=' mt-[15px] shadowed homebuttons2 text-[14px] lg:text-[17.95px] leading-[21.72px] font-medium text-[#fff]'>
