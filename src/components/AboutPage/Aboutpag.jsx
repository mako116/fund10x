...
const Abouts = () => {
  return (
    ...
    <path d="M0 62.3137V17.0134C0 7.67107 7.66962 0.148921 17.0102 0.330287L416.688 8.09082C433.46 8.41649 439.319 30.5092 424.912 39.1039L361.987 76.6437C359.402 78.1858 356.448 79 353.438 79H16.6863C7.4707 79 0 71.5293 0 62.3137Z" fill="white"/>
    </svg>
    </div>
    <div className='shadowed-tree  z-[-900px]'>
    <svg className='z-[100000px] relative'  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 436 82" fill="none">
 ...
 About 
     ...
     <div className="">
     <Image width={100} height={30} src={happy} className='lg:w-[886px] w-[400px] h-[300px] lg:h-[590.74px] rounded-[10px] '/>
     </div>
     </div>
